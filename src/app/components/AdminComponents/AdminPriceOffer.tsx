...
const AdminPriceOffer = ({ language }: Props) => {
  ...
  const { data, error, isLoading } = useQuery<PriceOffer | null>({
    ...
    queryFn: () => fetchPriceOfferAdmin(language),
    staleTime: 1000 * 60 * 5,
  ...
  useEffect(() => {
    if (data) {
      setActualizeData((prevData) => ({
        ...prevData,
        cennik_stiahnutie: data.cennik_stiahnutie,
        ceny_sposob_nadpis: data.ceny_sposob_nadpis,
        ceny_sposob_popis: data.ceny_sposob_popis,
        popis_nad_fotkou: data.popis_nad_fotkou,
        ...
        profil_popis5: data.profil_popis5,
        profil_popis6: data.profil_popis6,
        dielo_nadpis: data.dielo_nadpis,
        dielo_popis: data.dielo_popis,
        relacia_nadpis: data.relacia_nadpis,
        relacia_popis1: data.relacia_popis1,
        relacia_popis2: data.relacia_popis2,
        relacia_lista1: data.relacia_lista1,
        relacia_lista2: data.relacia_lista2,
        ...
        nacenovac: data.nacenovac,
        nacenovac_sekcie:
          data.nacenovac_sekcie.length > 0
            ? data.nacenovac_sekcie
            : NacenovacValues,
        posl_popis1: data.posl_popis1,
        posl_popis2: data.posl_popis2,
        posl_popis3: data.posl_popis3,
        posl_popis4: data.posl_popis4,
      }));
    }
  }, [data]);
  ...
  useEffect(() => {
    if (error) {
      setActualizeData((prevData) => ({
        ...
        relacia_lista1: "",
        relacia_lista2: "",
        relacie: RelacieValues,
        cenova_ponuka_nadpis: "",
        cenova_ponuka_popis: "",
        nacenovac: "",
        nacenovac_sekcie: NacenovacValues,
        posl_popis1: "",
        posl_popis2: "",
        posl_popis3: "",
        posl_popis4: "",
