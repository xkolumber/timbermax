...
import { fetchHomepageAdmin } from "@/app/lib/functionsServer";
...
const AdminHomePage = ({ language }: Props) => {
  ...
  const { data, error, isLoading } = useQuery<HomePageElements | null>({
    ...
    queryFn: () => fetchHomepageAdmin(language),
    staleTime: 1000 * 60 * 5,
  ...
  useEffect(() => {
    if (data) {
      setActualizeData((prevData) => ({
        ...
        jazyk: data.jazyk,
        mapa_showroomov: data.mapa_showroomov,
        ...
        rokov_skusenosti: data.rokov_skusenosti,
        sluzby: data.sluzby,
        ...
        text_photo1: data.text_photo1,
        text_photo2: data.text_photo2,
        text_photo3: data.text_photo3,
        text_photo4: data.text_photo4,
        text_photo5: data.text_photo5,
        text_photo6: data.text_photo6,
        text_photo7: data.text_photo7,
        text_photo8: data.text_photo8,
        references_title: data.references_title,
  ...
  useEffect(() => {
    if (error) {
      setActualizeData((prevData) => ({
        ...
        o_nas_nadpis: "",
        o_nas_popis: "",
        o_nas_elements: empty_four_values,
        ref_elements: empty_four_values,
        rokov_skusenosti: "",
        sluzby: EmptyServices,
        svg_titles: empty_three_values,
        timbermax_ako: EmptyTimbermaxLike,
        timbermax_ako_mobile_nadpis: "",
        timbermax_ako_mobile_popisy: EmptyTimbermaxLike,
        text_photo1: "",
        text_photo2: "",
        text_photo3: "",
        text_photo4: "",
            ...
            <div className="flex flex-col">
              {actualizeData.svg_titles.map((size, index) => (
                <input
                  key={index}
                  type="text"
                  name={`svg_titles${index}`}
                  value={size}
                  onChange={(e) =>
                    handleChangeItemArray("svg_titles", index, e)
                  }
                  className="md:!w-[450px] mt-2"
                />
              ))}
