...
import { Jazyk, Ploty, Slnolamy, Terasy } from "@/app/lib/interface";
...
const AdminTerasy = ({ language, data, languages }: Props) => {
  ...
  const handleSaveProduct = async (e: any) => {
    ...
    const response = await AdminActualizeTerasyPage(actualizeData, language);
    setIsLoading(false);
    if (response === "success") {
